...
PROJECT_NAME="cv-engine-streamlit-ui-stage"
CFT_MODULES_S3_BUCKET="https://hh-cv-cft-modules.s3.us-west-2.amazonaws.com/stage"
CFT_SERVICES_S3_BUCKET="https://hh-cv-services-deployment-bucket.s3.us-west-2.amazonaws.com/$PROJECT_NAME"
S3_BUCKET_NAME="cv-engine-streamlit-ui-stage"
...
ENV_FILE_ARN="arn:aws:s3:::hh-cv-services-deployment-bucket/cv-engine-stage/cv_engine_env_variable.env"
...
create-stack() {
	...
	--template-body "file://deploy/cft-services/stage/cv_engine.json" \
